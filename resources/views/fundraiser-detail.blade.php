...
@section('title', $fundraiser->programme_name)
...
<div class="breadcrumb-wrapper">
    <div class="breadcrumb-inner">
        ...
        <div class="breadcrumb-path">
            ...
            <span class="breadcrumb-current">{{ strtoupper($fundraiser->programme_name) }}</span>
        </div>
    </div>
</div>

<!-- Hero Section -->
<div class="hero-section" style="background-image: url('{{ asset('storage/' . $fundraiser->image_path) }}')">
    <div class="hero-overlay">
        <div class="hero-content">
            <div class="hero-text-wrapper">
                <h1 class="hero-title">{{ $fundraiser->programme_name }}</h1>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="detail-grid">
            ...
            <div class="detail-main">
                ...
                <div class="info-card">
                    ...
                    <div class="info-row">
                        ...
                        <span class="info-value">{{ $fundraiser->programme_name }}</span>
                    </div>

                    <div class="info-row">
                        <span class="info-label">Description</span>
                        <p class="info-text" style="white-space: pre-wrap;">{!! nl2br(e($fundraiser->description)) !!}</p>
                    </div>
                </div>
                ...
                <div class="progress-card">
                    ...
                    <div class="progress-stats">
                        <div class="stat-item">
                            <span class="stat-value">RM {{ number_format($fundraiser->total_raised, 2) }}</span>
                        ...
                        <div class="stat-item">
                            <span class="stat-value">RM {{ number_format($fundraiser->target_amount, 2) }}</span>
                    ...
                    <div class="progress-bar-wrapper">
                        ...
                        <div class="progress-bar">
                            <div class="progress-fill" style="width: {{ $percent }}%;">
                                <span class="progress-text">{{ number_format($percent, 2) }}%</span>
                            </div>
                        </div>
                    </div>

                    <p class="progress-message">
                        {{ $percent >= 100 ? 'Target achieved! Thank you for your support.' : 'Your contribution would make a difference' }}
                    </p>
                </div>
            </div>
            ...
            <div class="detail-sidebar">
                ...
                <div class="donation-card">
                    ...
                    <a href="{{ route('fundraiser.donate.form', $fundraiser->id) }}"
                       class="donate-btn"
                ...
                <div class="supporters-card">
                    ...
                    <div class="supporters-info">
                        <span class="supporters-count">{{ $fundraiser->donors->count() }}</span>
