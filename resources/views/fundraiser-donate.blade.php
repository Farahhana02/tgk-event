...
@section('title', 'Donate to ' . $fundraiser->programme_name)
...
<div class="breadcrumb-wrapper">
    <div class="breadcrumb-inner">
        ...
        <div class="breadcrumb-path">
            ...
            <a href="{{ route('fundraiser.detail', $fundraiser->id) }}" class="breadcrumb-link">
                {{ strtoupper($fundraiser->programme_name) }}
            </a>
            <span>/</span>
    ...
    <div class="container" style="max-width: 800px;">
        <div class="donation-card" style="margin: 0 auto;">
            ...
            <p class="donation-subtitle">
                ...
                <strong>{{ strtoupper($fundraiser->programme_name) }}</strong>.
            </p>

            <form id="donationForm"
                  action="{{ route('fundraiser.donate', $fundraiser->id) }}"
                  method="POST"
                ...
                @if($fundraiser->form_path)
                    ...
                    <div class="form-group">
                       ...
                       <a href="{{ asset('storage/'.$fundraiser->form_path) }}"
                            target="_blank"
    ...
    .then(data => {
        if(data.success) {
            Swal.fire({
                ...
                window.location.href = "{{ route('fundraiser.detail', $fundraiser->id) }}";
            });
        } else {
            Swal.fire({
                title: 'Error!',
