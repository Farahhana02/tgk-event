...
<div class="breadcrumb-wrapper">
    <div class="breadcrumb-inner">
        <div class="breadcrumb-title">{{ strtoupper($program->title) }}</div>
        <div class="breadcrumb-path">
            <a href="{{ route('admin.index') }}">
                <img src="{{ asset('assets/icons/Home.png') }}" class="breadcrumb-home-icon">
            </a>
            <span>/</span>
            <a href="{{ route('admin.programs.index') }}" class="breadcrumb-link">PROGRAMMES</a>
            <span>/</span>
            <span class="breadcrumb-current">{{ strtoupper($program->title) }}</span>
        </div>
    </div>
</div>
            ...
            <div class="section-actions">
                ...
                <label class="section-toggle">
                    <input type="checkbox"
                           ...
                           {{ isset($program->visible_sections['overview']) ? ($program->visible_sections['overview'] ? 'checked' : '') : 'checked' }}>
            ...
            <div class="section-actions">
                ...
                <label class="section-toggle">
                    <input type="checkbox"
                           ...
                           onchange="toggleSectionDisplay(this); event.stopPropagation();"
                           {{ isset($program->visible_sections['tentative']) ? ($program->visible_sections['tentative'] ? 'checked' : '') : 'checked' }}>
                    <span class="toggle-slider" onclick="event.stopPropagation();"></span>
                </label>
            </div>
        </div>
            ...
            <div class="section-actions">
                ...
                <label class="section-toggle">
                    <input type="checkbox"
                           data-section="vip"
                           onchange="toggleSectionDisplay(this); event.stopPropagation();"
                           {{ isset($program->visible_sections['vip']) ? ($program->visible_sections['vip'] ? 'checked' : '') : 'checked' }}>
                    <span class="toggle-slider" onclick="event.stopPropagation();"></span>
                </label>
            </div>
        </div>
            ...
            <div class="section-actions">
                ...
                <label class="section-toggle">
                    <input type="checkbox"
                           ...
                           onchange="toggleSectionDisplay(this); event.stopPropagation();"
                           {{ isset($program->visible_sections['participation']) ? ($program->visible_sections['participation'] ? 'checked' : '') : 'checked' }}>
                    <span class="toggle-slider" onclick="event.stopPropagation();"></span>
                </label>
            </div>
        </div>
            ...
            <div class="section-actions">
                ...
                <label class="section-toggle">
                    <input type="checkbox"
                           ...
                           onchange="toggleSectionDisplay(this); event.stopPropagation();"
                           {{ isset($program->visible_sections['sponsorship']) ? ($program->visible_sections['sponsorship'] ? 'checked' : '') : 'checked' }}>
                    <span class="toggle-slider" onclick="event.stopPropagation();"></span>
                </label>
            </div>
        </div>
        ...
        <div class="section-actions">
            ...
            <label class="section-toggle">
                <input type="checkbox"
                       data-section="photo"
                       onchange="toggleSectionDisplay(this); event.stopPropagation();"
                       {{ isset($program->visible_sections['photo']) ? ($program->visible_sections['photo'] ? 'checked' : '') : 'checked' }}>
                <span class="toggle-slider" onclick="event.stopPropagation();"></span>
            </label>
        </div>
    </div>
            ...
            <div class="section-actions">
                ...
                <label class="section-toggle">
                    <input type="checkbox"
                           ...
                           onchange="toggleSectionDisplay(this); event.stopPropagation();"
                           {{ isset($program->visible_sections['programme']) ? ($program->visible_sections['programme'] ? 'checked' : '') : 'checked' }}>
                    <span class="toggle-slider" onclick="event.stopPropagation();"></span>
                </label>
            </div>
        </div>
        ...
        <div class="section-actions">
            ...
            <label class="section-toggle">
                <input type="checkbox"
                       ...
                       onchange="toggleSectionDisplay(this); event.stopPropagation();"
                       {{ isset($program->visible_sections['link-participation']) ? ($program->visible_sections['link-participation'] ? 'checked' : '') : 'checked' }}>
                <span class="toggle-slider" onclick="event.stopPropagation();"></span>
            </label>
        </div>
    </div>
...
<div id="overview-section" class="section-editor" style="display: none;">
    ...
    <div class="breadcrumb-path" style="margin-bottom: 20px;">
        ...
        <span>/</span>
        <a href="{{ route('admin.programs.index') }}" style="color: #6B7280;">PROGRAMMES</a>
        <span>/</span>
        <a href="{{ route('admin.programs.show', $program->id) }}" style="color: #6B7280;">{{ strtoupper($program->title) }}</a>
        <span>/</span>
       ...
       style="text-transform: uppercase !important; background:#f3f4f6; cursor:not-allowed;">
        ...
        <div class="form-group">
            ...
            <div id="introductionContainer">
                @if($program->introduction && is_array($program->introduction))
                    @foreach($program->introduction as $index => $paragraph)
                        <div class="paragraph-item">
                            <textarea name="introduction[]" class="form-control paragraph-input" 
                                      rows="3" placeholder="Write paragraph here">{{ $paragraph }}</textarea>
                            @if($index > 0)
        ...
        <div class="form-group">
            ...
            <div id="backgroundContainer">
                @if($program->background && is_array($program->background))
                    @foreach($program->background as $index => $paragraph)
                        <div class="paragraph-item">
                            <textarea name="background[]" class="form-control paragraph-input" 
                                      rows="3" placeholder="Write background paragraph here">{{ $paragraph }}</textarea>
                            @if($index > 0)
                    ...
                    @foreach($program->objectives as $index => $objective)
                        <div class="point-item">
                            <textarea name="objectives[]" class="form-control point-input" 
                                      rows="2" placeholder="Write objective point here">{{ $objective }}</textarea>
                            @if($index > 0)
...
<div id="tentative-section" class="section-editor" style="display: none;">
    ...
    <input type="hidden" name="event_date" value="{{ $program->event_date }}">
    <input type="hidden" name="event_time" value="{{ $program->event_time }}">
    <input type="hidden" name="location" value="{{ $program->location }}">
    <input type="hidden" name="theme" value="{{ $program->theme }}">

        <div class="tentative-info">
            <div class="info-row">
                <label>DATE :</label>
                <span>{{ $program->event_date ? \Carbon\Carbon::parse($program->event_date)->format('d/m/Y') : 'XXX' }}</span>
            </div>
            <div class="info-row">
                <label>TIME :</label>
                <span>{{ $program->event_time ? \Carbon\Carbon::parse($program->event_time)->format('h:i A') : 'XXX' }}</span>
            </div>
            <div class="info-row">
                <label>VENUE :</label>
                <span>{{ strtoupper($program->location ?? 'XXX') }}</span>
            </div>
            <div class="info-row">
                <label>THEME :</label>
                <span>{{ strtoupper($program->theme ?? 'XXX') }}</span>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div id="schedulesContainer">
                @if($program->schedules && count($program->schedules) > 0)
                    @foreach($program->schedules as $index => $schedule)
                    <div class="schedule-item">
                        <input type="text" name="schedules[{{ $index }}][time]" 
                               class="form-control schedule-time" placeholder="XX:XX a.m/p.m"
                               value="{{ $schedule['time'] ?? '' }}">
                        <input type="text" name="schedules[{{ $index }}][description]" 
...
<div id="vip-section" class="section-editor" style="display: none;">
    ...
    <form id="vipForm" class="section-form" enctype="multipart/form-data" onsubmit="saveVip(event)">
        @csrf
        <div id="vipContainer">
            @if($program->vip_list && count($program->vip_list) > 0)
                @foreach($program->vip_list as $index => $vip)
                <div class="vip-item" data-index="{{ $index }}">
                    <div class="vip-image-upload">
                        @if(isset($vip['image']) && $vip['image'])
                        <img src="{{ asset('storage/' . $vip['image']) }}" class="vip-preview" id="vipPreview{{ $index }}">
                        @else
                        ...
                        @endif
                        <input type="file" name="vip_list[{{ $index }}][image]" class="vip-file-input" 
                               accept="image/*" onchange="previewVipImage(this, {{ $index }})">
                        <input type="hidden" name="vip_list[{{ $index }}][existing_image]" value="{{ $vip['image'] ?? '' }}">
                    </div>
                    <div class="vip-details">
                        <input type="text" name="vip_list[{{ $index }}][name]" 
                               class="form-control" placeholder="NAME" value="{{ $vip['name'] ?? '' }}" required>
                        <input type="text" name="vip_list[{{ $index }}][position]" 
                               class="form-control" placeholder="POSITION" value="{{ $vip['position'] ?? '' }}" required>
                    </div>
    ...
    <form id="participationForm" class="section-form" enctype="multipart/form-data" onsubmit="saveParticipation(event)">
        ...
        <div class="form-group">
            ...
            <div id="participationDescContainer">
                @if($program->participation_description && is_array($program->participation_description))
                    @foreach($program->participation_description as $index => $paragraph)
                        <div class="paragraph-item">
                            <textarea name="participation_description[]" class="form-control paragraph-input" 
                                      rows="3" placeholder="Write participation description paragraph">{{ $paragraph }}</textarea>
                            @if($index > 0)
        ...
        <div class="form-group">
            ...
            <div id="priceContainer">
                @if($program->participation_prices && count($program->participation_prices) > 0)
                    @foreach($program->participation_prices as $index => $price)
                    <div class="price-item">
                        <input type="text" name="participation_prices[{{ $index }}][description]" 
                               class="form-control price-desc" placeholder="ex: Per person"
                               value="{{ $price['description'] ?? '' }}">
                        <input type="text" name="participation_prices[{{ $index }}][amount]" 
                    ...
                    <div class="file-display-box">
                        ...
                        <div class="file-display-footer">
                            <button type="button" 
                                    ...
                                    onclick="removeAdditionalFile('participation_additional_files', '{{ $program->participation_additional_files }}')">
                                 Remove File
                            </button>
                        </div>
                    </div>
        ...
        <div class="form-group">
            ...
            <div class="form-type-toggle-wrapper">
                <div class="form-type-toggle">
                    <button type="button" 
                            class="toggle-btn {{ $program->participation_form_type === 'file' || !$program->participation_form_type ? 'active' : '' }}" 
                            onclick="toggleFormType('participation', 'file')">
                        <span class="toggle-icon"></span>
                        FILES PDF
                    </button>
                    <button type="button" 
                            class="toggle-btn {{ $program->participation_form_type === 'link' ? 'active' : '' }}" 
            ...
            <!-- FILE PDF SECTION -->
            <div id="participationFileInput" style="display: {{ $program->participation_form_type === 'link' ? 'none' : 'block' }}">
                <div class="file-management-section">
                    <!-- Upload Area -->
                    <div class="file-upload-box">
                        <div class="file-input-wrapper">
                    ...
                    @if($program->participation_form && $program->participation_form_type === 'file')
                        <div class="file-display-box">
                            ...
                            <div class="file-display-footer">
                                <button type="button" 
                                        class="btn-remove-file" 
                                        onclick="removeFormFile('participation_form', '{{ $program->participation_form }}')">
                                    Remove File
                                </button>
                            </div>
                        </div>
            ...
            <!-- LINK SECTION -->
            <div id="participationLinkInput" style="display: {{ $program->participation_form_type === 'link' ? 'block' : 'none' }}">
                <input type="url" 
                       name="participation_form_link" 
                       class="form-control" 
                       placeholder="https://example.com/form"
                       value="{{ $program->participation_form_type === 'link' ? $program->participation_form : '' }}">
            </div>
            
            <input type="hidden" name="participation_form_type" id="participationFormType" value="{{ $program->participation_form_type ?? 'file' }}">
        </div>
        ...
        <form id="sponsorshipForm" class="section-form" enctype="multipart/form-data" onsubmit="saveSponsorship(event)">
            ...
            <div class="form-group">
                ...
                <div id="sponsorshipDescContainer">
                    @if($program->sponsorship_description && is_array($program->sponsorship_description))
                        @foreach($program->sponsorship_description as $index => $paragraph)
                            <div class="paragraph-item">
                                <textarea name="sponsorship_description[]" class="form-control paragraph-input" 
                                        rows="3" placeholder="Write sponsorship description paragraph">{{ $paragraph }}</textarea>
                                @if($index > 0)
            ...
            <div class="form-group">
                ...
                <div id="packageContainer">
                    @if($program->sponsorship_packages && count($program->sponsorship_packages) > 0)
                        @foreach($program->sponsorship_packages as $index => $package)
                        <div class="price-item">
                            <input type="text" name="sponsorship_packages[{{ $index }}][description]" 
                                class="form-control price-desc" placeholder="ex: Platinum"
                                value="{{ $package['description'] ?? '' }}">
                            <input type="text" name="sponsorship_packages[{{ $index }}][amount]" 
                                class="form-control price-amount" placeholder="RM xxxx"
        ...
        @if($program->sponsorship_additional_files)
            <div class="file-display-box">
                ...
                <div class="file-display-footer">
                    <button type="button" 
                            class="btn-remove-file" 
                            onclick="removeAdditionalFile('sponsorship_additional_files', '{{ $program->sponsorship_additional_files }}')">
                         Remove File
                    </button>
                </div>
            </div>
...
<div class="form-group">
    ...
    <div class="form-type-toggle-wrapper">
        <div class="form-type-toggle">
            <button type="button" 
                    class="toggle-btn {{ $program->sponsorship_form_type === 'file' || !$program->sponsorship_form_type ? 'active' : '' }}" 
                    onclick="toggleFormType('sponsorship', 'file')">
                <span class="toggle-icon"></span>
                FILES PDF
            </button>
            <button type="button" 
                    class="toggle-btn {{ $program->sponsorship_form_type === 'link' ? 'active' : '' }}" 
    ...
    <!-- FILE PDF SECTION -->
    <div id="sponsorshipFileInput" style="display: {{ $program->sponsorship_form_type === 'link' ? 'none' : 'block' }}">
        <div class="file-management-section">
            <!-- Upload Area -->
            <div class="file-upload-box">
                <div class="file-input-wrapper">
            ...
            @if($program->sponsorship_form && $program->sponsorship_form_type === 'file')
                <div class="file-display-box">
                    ...
                    <div class="file-display-footer">
                        <button type="button" 
                                class="btn-remove-file" 
                                onclick="removeFormFile('sponsorship_form', '{{ $program->sponsorship_form }}')">
                             Remove File
                        </button>
                    </div>
                </div>
    ...
    <!-- LINK SECTION -->
    <div id="sponsorshipLinkInput" style="display: {{ $program->sponsorship_form_type === 'link' ? 'block' : 'none' }}">
        <input type="url" 
               name="sponsorship_form_link" 
               class="form-control" 
               placeholder="https://example.com/form"
               value="{{ $program->sponsorship_form_type === 'link' ? $program->sponsorship_form : '' }}">
    </div>
    
    <input type="hidden" name="sponsorship_form_type" id="sponsorshipFormType" value="{{ $program->sponsorship_form_type ?? 'file' }}">
</div>
    ...
    <form id="linkParticipationForm" onsubmit="saveLinkParticipation(event)">
        ...
        <div class="form-group">
            ...
            <select name="participation_programme_id" id="participationProgrammeSelect" class="form-control">
                ...
                @endphp
                @foreach($participationProgrammes as $pp)
                    <option value="{{ $pp->id }}" 
                            {{ $program->participation_programme_id == $pp->id ? 'selected' : '' }}>
                        {{ $pp->title }}
                        @if($pp->start_date)
        ...
        @if($program->participation_programme_id)
            <div style="background: #f0f9f7; border: 2px solid #d4ebe5; border-radius: 8px; padding: 20px; margin-bottom: 20px;">
                ...
                <p style="margin: 0 0 10px 0; color: #374151;">
                    <strong>Participation Programme:</strong> {{ $program->participationProgramme->title ?? 'Unknown' }}
                </p>
                <a href="{{ route('admin.participations.participant_list', $program->participation_programme_id) }}" 
                   target="_blank"
                   class="btn-preview"
...
window.scheduleCounter = {{ $program->schedules ? count($program->schedules) : 1 }};
window.vipCounter = {{ $program->vip_list ? count($program->vip_list) : 1 }};
window.priceCounter = {{ $program->participation_prices ? count($program->participation_prices) : 1 }};
window.packageCounter = {{ $program->sponsorship_packages ? count($program->sponsorship_packages) : 1 }};
...
// Or add to admin-template.blade.php in the @stack('scripts') section
