...
<?php $__env->startSection('title', 'Home - Kedah Forward'); ?>
...
========================== -->
<section class="hero">
    <div class="hero-bg" style="background-image: url('<?php echo e(asset('assets/images/bg.png')); ?>');"></div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp2\htdocs\dashboard\kedahforward\resources\views/home.blade.php ENDPATH**/ ?>