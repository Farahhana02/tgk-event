...
<?php $__env->startSection('title', 'Participation Form'); ?>

<?php $__env->startSection('content'); ?>
<link rel="stylesheet" href="<?php echo e(asset('assets/css/admin-participations-form.css')); ?>">
    ...
    <div class="paf-card">
        ...
        <div class="paf-grid-2">
            <div class="paf-field">
                ...
                <input class="paf-input" value="<?php echo e($programme->title); ?>" readonly>
            </div>
            <div class="paf-field">
                <div class="paf-label">Venue</div>
                <input class="paf-input" value="<?php echo e($programme->venue ?? '-'); ?>" readonly>
            </div>
        </div>
        <div class="paf-grid-3" style="margin-top:12px;">
            <div class="paf-field">
                <div class="paf-label">Start Date</div>
                <input class="paf-input" value="<?php echo e(optional($programme->start_date)->format('d/m/Y')); ?>" readonly>
            </div>
            <div class="paf-field">
                <div class="paf-label">End Date</div>
                <input class="paf-input" value="<?php echo e(optional($programme->end_date)->format('d/m/Y')); ?>" readonly>
            </div>
            <div class="paf-field">
                ...
                ?>
                <input class="paf-input" value="<?php echo e($timeDisplay); ?>" readonly>
            </div>
        </div>
    </div>
...
<?php if($allExistingPackages->isNotEmpty()): ?>
    <div class="paf-field" style="margin-bottom:20px;">
        ...
        <select id="existingPackageSelect" class="paf-select" 
            ...
            <?php $__currentLoopData = $allExistingPackages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pkg): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php if(!$pkg->is_used_in_current): ?>
                    <option value="<?php echo e($pkg->id); ?>" 
                            data-name="<?php echo e($pkg->name); ?>"
                            data-type="<?php echo e($pkg->package_type); ?>"
                            data-price="<?php echo e($pkg->price); ?>"
                            data-people="<?php echo e($pkg->people_per_package); ?>"
                            data-description="<?php echo e($pkg->description); ?>">
                        <?php echo e($pkg->name); ?> 
                        (<?php echo e(strtoupper(str_replace('_', ' ', $pkg->package_type))); ?>)
                        - RM <?php echo e(number_format($pkg->price, 2)); ?>

                        <?php if($pkg->total_usage > 0): ?>
                            <small style="color:#6B7280;">(Used <?php echo e($pkg->total_usage); ?> time<?php echo e($pkg->total_usage > 1 ? 's' : ''); ?>)</small>
                        <?php endif; ?>
                    </option>
                <?php endif; ?>
...
<div class="paf-form-section">
    ...
    <form id="packageForm" method="POST" 
          action="<?php echo e(route('admin.participations.packages.store.new', $programme->id)); ?>">
        <?php echo csrf_field(); ?>
...
<?php if($selectedProgrammePackages->isNotEmpty()): ?>
    <div class="paf-divider" style="margin:24px 0;"></div>

    <div class="paf-note" style="margin-bottom:12px; font-weight:600; color:#00542A;">
        ✅ Saved Packages for <?php echo e($programme->title); ?>:
    </div>

    <div class="paf-list">
        <?php $__currentLoopData = $selectedProgrammePackages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $progPkg): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="paf-item" style="<?php echo e($progPkg->is_override ? 'border-left: 3px solid #C08329; background-color: #FEF3C7; padding-left: 12px;' : ''); ?>">

                <div class="paf-item-left">
                    <div class="paf-item-title">
                        <?php echo e($progPkg->name); ?>


                        <?php if($progPkg->is_override): ?>
                    ...
                    <div class="paf-item-sub">
                        <div><strong>Type:</strong> <?php echo e(strtoupper(str_replace('_', ' ', $progPkg->package_type))); ?></div>

                        <div>
                            <strong>Price:</strong> RM <?php echo e(number_format($progPkg->price, 2)); ?>

                        </div>

                        <?php if($progPkg->people_per_package): ?>
                            <div>
                                <strong>People per Package:</strong> <?php echo e($progPkg->people_per_package); ?>

                            </div>
                        <?php endif; ?>

                        <?php if($progPkg->description): ?>
                            <div>
                                <strong>Description:</strong> <?php echo e($progPkg->description); ?>
                ...
                <div style="display:flex; gap:8px;">
                    <button type="button" class="paf-btn paf-btn-outline"
                        onclick="editPackage(<?php echo e($progPkg->id); ?>, '<?php echo e(addslashes($progPkg->name)); ?>', '<?php echo e($progPkg->package_type); ?>', <?php echo e($progPkg->price); ?>, '<?php echo e(addslashes($progPkg->description ?? '')); ?>', <?php echo e($progPkg->people_per_package ?? 'null'); ?>, <?php echo e($progPkg->is_override ? 'true' : 'false'); ?>)">
                        ✏️ EDIT
                    </button>

                    <form method="POST"
                        action="<?php echo e(route('admin.participations.packages.destroy', [$programme->id, $progPkg->id])); ?>"
                        onsubmit="return confirmPackageDelete(this, '<?php echo e(addslashes($progPkg->name)); ?>')">
                        <?php echo csrf_field(); ?>
...
<?php if($allExistingPaymentMethods->isNotEmpty()): ?>
    <div class="paf-field" style="margin-bottom:20px;">
        <div class="paf-label" style="color:#C08329; font-weight:600;">
            📋 Quick Select from Previous Programmes (Optional)
        </div>
        <select id="existingPaymentSelect" class="paf-select" 
            ...
            <option value="">— Select to auto-fill form below —</option>
            <?php $__currentLoopData = $allExistingPaymentMethods; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pm): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php if(!$pm->is_used_in_current): ?>
                    <option value="<?php echo e($pm->id); ?>"
                            data-bank="<?php echo e($pm->bank); ?>"
                            data-account-name="<?php echo e($pm->account_name); ?>"
                            data-account-number="<?php echo e($pm->account_number); ?>">
                        <?php echo e($pm->bank); ?> - <?php echo e($pm->account_name); ?> (<?php echo e($pm->account_number); ?>)
                        <?php if($pm->total_usage > 0): ?>
                            <small style="color:#6B7280;">(Used <?php echo e($pm->total_usage); ?> time<?php echo e($pm->total_usage > 1 ? 's' : ''); ?>)</small>
                        <?php endif; ?>
                    </option>
                <?php endif; ?>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<form id="paymentForm" method="POST" enctype="multipart/form-data"
      action="<?php echo e(route('admin.participations.payment_methods.store.new', $programme->id)); ?>">
        <?php echo csrf_field(); ?>
...
<?php if($selectedPaymentMethods->isNotEmpty()): ?>
    <div class="paf-divider" style="margin:24px 0;"></div>

    <div class="paf-note" style="margin-bottom:12px; font-weight:600; color:#00542A;">
        ✅ Saved Payment Methods for <?php echo e($programme->title); ?>:
    </div>

    <div class="paf-list">
        <?php $__currentLoopData = $selectedPaymentMethods; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $progPM): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="paf-item" style="<?php echo e($progPM->is_override ? 'border-left: 3px solid #C08329; background-color: #FEF3C7; padding-left: 12px;' : ''); ?>">
                <div class="paf-item-left">
                    <div class="paf-item-title">
                        <?php echo e($progPM->bank); ?>

                        <?php if($progPM->is_override): ?>
                            <span style="background:#C08329; color:white; padding:2px 8px; border-radius:4px; font-size:11px; margin-left:8px;">
                                OVERRIDE
                            </span>
                        <?php endif; ?>
                    ...
                    <div class="paf-item-sub paf-payment-details">
                        ...
                        <div>
                            <strong>Account Name:</strong> <?php echo e($progPM->account_name); ?>

                            <?php if($progPM->is_override && isset($progPM->master_data['default_account_name'])): ?>
                                <small style="color:#6B7280; margin-left: 8px;">
                                    (Master: <?php echo e($progPM->master_data['default_account_name']); ?>)
                                </small>
                            <?php endif; ?>
                        </div>
                        ...
                        <div>
                            <strong>Account Number:</strong> <?php echo e($progPM->account_number); ?>

                            <?php if($progPM->is_override && isset($progPM->master_data['default_account_number'])): ?>
                                <small style="color:#6B7280; margin-left: 8px;">
                                    (Master: <?php echo e($progPM->master_data['default_account_number']); ?>)
                                </small>
                            <?php endif; ?>
                        </div>
                    </div>
                ...
                <div style="display:flex; gap:8px;">
                    <button type="button" class="paf-btn paf-btn-outline"
                            onclick="editPayment(<?php echo e($progPM->id); ?>, '<?php echo e(addslashes($progPM->bank)); ?>', '<?php echo e(addslashes($progPM->account_name)); ?>', '<?php echo e($progPM->account_number); ?>', <?php echo e($progPM->is_override ? 'true' : 'false'); ?>)">
                        ✏️ EDIT
                    </button>

                    <form method="POST"
                        action="<?php echo e(route('admin.participations.payment_methods.destroy', [$programme->id, $progPM->id])); ?>"
                        onsubmit="return confirmPaymentDelete(this, '<?php echo e(addslashes($progPM->bank)); ?>')">
                        <?php echo csrf_field(); ?>
                        <?php echo method_field('DELETE'); ?>
                        <button class="paf-btn paf-btn-danger" type="submit">🗑️ DELETE</button>
                    </form>
...
<div class="paf-card">
    ...
    <form method="POST"
          action="<?php echo e(route('admin.participations.form.save', $programme->id)); ?>"
          enctype="multipart/form-data"
          id="qrUploadForm">
        <?php echo csrf_field(); ?>

        <div class="paf-field">
            <?php if($programme->qr_path): ?>
                <div class="qr-box">
                    <div class="qr-row">
                        <img src="<?php echo e(asset('storage/'.$programme->qr_path)); ?>" class="qr-thumb">

                        <div class="qr-info">
                            <div class="qr-title">Current QR Code</div>
                            <div class="qr-filename"><?php echo e(basename($programme->qr_path)); ?></div>
                        </div>

                        <div class="qr-actions">
                            <button type="button"
                                    onclick="previewQR('<?php echo e(asset('storage/'.$programme->qr_path)); ?>')"
            ...
            <button type="button"
                    ...
                    class="qr-upload-btn">
                📁 <?php echo e($programme->qr_path ? 'REPLACE QR CODE' : 'UPLOAD QR CODE'); ?>
...
<form id="deleteQRForm"
      action="<?php echo e(route('admin.participations.qr.delete', $programme->id)); ?>"
      method="POST"
      style="display:none;">
    <?php echo csrf_field(); ?>
    <?php echo method_field('DELETE'); ?>
...
<div class="paf-card">
    ...
    <form method="POST"
        ...
        <div class="paf-field">
            ...
            <?php if($programme->upload_form_path): ?>
                <div class="upload-form-box">
                    <div class="form-row">
                        <div class="form-info">
                            <div class="form-title">📋 Current Upload Form</div>
                            <div class="form-filename"><?php echo e(basename($programme->upload_form_path)); ?></div>
                        </div>

                        <div class="form-actions">
                            <button type="button"
                                    onclick="previewForm('<?php echo e(asset('storage/'.$programme->upload_form_path)); ?>')"
                                    class="paf-btn paf-btn-outline">
                                👁️ Preview
                            </button>
            ...
            <button type="button"
                ...
                📁 <?php echo e($programme->upload_form_path ? 'REPLACE FORM' : 'UPLOAD FORM'); ?>
...
<form id="deleteFormForm"
      action="<?php echo e(route('admin.participations.form.delete', $programme->id)); ?>"
      method="POST"
      style="display:none;">
    <?php echo csrf_field(); ?>
    <?php echo method_field('DELETE'); ?>
...
<div class="paf-card">
    ...
    <form method="POST" action="<?php echo e(route('admin.participations.form.save', $programme->id)); ?>"
        ...
        <div class="paf-field" style="max-width: 400px;">
            ...
            <select class="paf-select" name="is_active" id="formActiveSelect">
                <option value="1" <?php echo e($programme->is_active ? 'selected' : ''); ?>>YES</option>
                <option value="0" <?php echo e(!$programme->is_active ? 'selected' : ''); ?>>NO</option>
            </select>
    ...
    <div class="paf-card">
        ...
        <div class="paf-actions-row">
            <form method="POST" action="<?php echo e(route('admin.participations.generate_link', $programme->id)); ?>">
                <?php echo csrf_field(); ?>
                <button class="paf-btn paf-btn-green" type="submit" style= "font-weight:600;">
                    <?php echo e($programme->public_token ? 'REGENERATE LINK' : '🔗 CREATE LINK'); ?>

                </button>
            </form>

            <?php if($programme->public_token): ?>
                <a class="paf-btn paf-btn-orange" 
                   href="<?php echo e(route('participation.public.form', $programme->public_token)); ?>"
...
<script src="<?php echo e(asset('assets/js/admin-participations-form.js')); ?>"></script>
<script>
...
<?php echo $__env->make('admin.layouts.admin-template', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp2\htdocs\dashboard\kedahforward\resources\views/admin/participations/form.blade.php ENDPATH**/ ?>