...
<aside id="sidebar" class="sidebar">
    <ul class="sidebar-menu">
        ...
        <li class="dropdown">
            <div class="dropdown-header <?php echo e(request()->is('programs/*') ? 'open' : ''); ?>" onclick="toggleProgrammesDropdown(event)">
                <button class="dropdown-arrow <?php echo e(request()->is('programs/*') ? 'open' : ''); ?>"></button>
                <span class="dropdown-title">PROGRAMMES</span>
            </div>

            <ul class="dropdown-menu <?php echo e(request()->is('programs/*') ? 'show' : ''); ?>">
<?php $__currentLoopData = $visiblePrograms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $program): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    ...
    ?>
                ...
                <li class="nested-dropdown">
                    <div class="nested-dropdown-header <?php echo e(request()->is('programs/'.$program->id.'*') ? 'open' : ''); ?>" 
                         onclick="toggleProgramNestedDropdown(event)">
                        <button class="nested-dropdown-arrow <?php echo e(request()->is('programs/'.$program->id.'*') ? 'open' : ''); ?>"></button>
                        <span class="nested-dropdown-title"><?php echo e(strtoupper($program->title)); ?></span>
                    </div>

                    <ul class="nested-dropdown-menu <?php echo e(request()->is('programs/'.$program->id.'*') ? 'show' : ''); ?>">
                        <?php if($isSectionVisible('overview')): ?>
                        <li>
                            <a href="<?php echo e(route('programs.show', ['id' => $program->id, 'section' => 'overview'])); ?>"
                               class="<?php echo e(request()->get('section') == 'overview' ? 'active' : ''); ?>">
                                Overview
                            </a>
                        </li>
                        <?php endif; ?>
                        
                        <?php if($isSectionVisible('tentative')): ?>
                        <li>
                            <a href="<?php echo e(route('programs.show', ['id' => $program->id, 'section' => 'tentative'])); ?>"
                               class="<?php echo e(request()->get('section') == 'tentative' ? 'active' : ''); ?>">
                                Programme Tentative
                            </a>
                        </li>
                        <?php endif; ?>
                        
                        <?php if($isSectionVisible('vip')): ?>
                        <li>
                            <a href="<?php echo e(route('programs.show', ['id' => $program->id, 'section' => 'vip'])); ?>"
                               class="<?php echo e(request()->get('section') == 'vip' ? 'active' : ''); ?>">
                                VIP
                            </a>
                        </li>
                        <?php endif; ?>
                        
                        <?php if($isSectionVisible('participation')): ?>
                        <li>
                            <a href="<?php echo e(route('programs.show', ['id' => $program->id, 'section' => 'participation'])); ?>"
                               class="<?php echo e(request()->get('section') == 'participation' ? 'active' : ''); ?>">
                                Participation
                            </a>
                        </li>
                        <?php endif; ?>
                        
                        <?php if($isSectionVisible('sponsorship')): ?>
                        <li>
                            <a href="<?php echo e(route('programs.show', ['id' => $program->id, 'section' => 'sponsorship'])); ?>"
                               class="<?php echo e(request()->get('section') == 'sponsorship' ? 'active' : ''); ?>">
                                Sponsorship
                            </a>
                        </li>
                        <?php endif; ?>

                        <?php if($isSectionVisible('photo')): ?>
                       <li>
                            <a href="<?php echo e(route('programs.show', ['id' => $program->id, 'section' => 'photo'])); ?>"
                                class="<?php echo e(request()->get('section') == 'photo' ? 'active' : ''); ?>">
                                 Photo of The Event
                                </a>
                            </li>
                        <?php endif; ?>
                        
                        <?php if($isSectionVisible('programme')): ?>
                        <li>
                            <a href="<?php echo e(route('programs.show', ['id' => $program->id, 'section' => 'programme'])); ?>"
                               class="<?php echo e(request()->get('section') == 'programme' ? 'active' : ''); ?>">
                    ...
                    <?php if($isSectionVisible('link-participation') && $program->participation_programme_id): ?>
                        <li>
                            <a href="<?php echo e(route('programs.show', ['id' => $program->id, 'section' => 'participant-list'])); ?>" 
                            class="<?php echo e(request()->get('section') == 'participant-list' ? 'active' : ''); ?>">
                                Participant List
                            </a>
                        </li>
                        <?php endif; ?>
        ...
        <!-- FUNDRAISER -->
        <li>
            <a href="<?php echo e(url('/fundraisers')); ?>"
               class="<?php echo e(request()->is('fundraisers*') ? 'active' : ''); ?>">
                Fundraising
            </a>
        </li>
...
</script><?php /**PATH C:\xampp2\htdocs\dashboard\kedahforward\resources\views/components/sidebar.blade.php ENDPATH**/ ?>