    ...
    <div class="breadcrumb-inner">
        ...
        <div class="breadcrumb-path">
            ...
            <span class="breadcrumb-current">
                PROGRAM <?php echo e(strtoupper($fundraiser->programme_name)); ?>
        ...
        <div class="info-card">
            ...
            <div class="info-grid-vertical">
                <div class="info-item-vertical">
                    ...
                    <span><?php echo e(strtoupper($fundraiser->programme_name)); ?></span>
                </div>

                <div class="info-item-vertical date-row">
                    <div class="date-item">
                        <strong>START DATE :</strong>
                        <span><?php echo e(\Carbon\Carbon::parse($fundraiser->start_date)->format('d/m/Y')); ?></span>
                    </div>
                    <span class="date-separator">-</span>
                    <div class="date-item">
                        <strong>END DATE :</strong>
                        <span><?php echo e(\Carbon\Carbon::parse($fundraiser->end_date)->format('d/m/Y')); ?></span>
                    </div>
                </div>

                <div class="info-item-vertical">
                    <strong>TARGET :</strong>
                    <span>RM <?php echo e(number_format($fundraiser->target_amount, 2)); ?></span>
                </div>

                <div class="info-item-vertical">
                    <strong>PROGRESS :</strong>
                    <span><?php echo e($fundraiser->progress); ?> %</span>
                </div>
            </div>
            ...
            <div class="fundraising-summary">
                <div class="summary-item raised">
                    ...
                    <div class="summary-value">
                        RM <?php echo e(number_format($fundraiser->total_raised ?? 0, 2)); ?>
                ...
                <div class="summary-item donors">
                    ...
                    <div class="summary-value"><?php echo e($fundraiser->donors->count()); ?></div>
                </div>

                <div class="summary-item remaining">
                    <div class="summary-label">REMAINING</div>
                    <div class="summary-value">
                        RM <?php echo e(number_format(max(0, $fundraiser->target_amount - ($fundraiser->total_raised ?? 0)), 2)); ?>
            ...
            <?php if($fundraiser->description): ?>
                <div class="description-section">
                    ...
                    <p><?php echo e(strtoupper($fundraiser->description)); ?></p>
                </div>
            <?php endif; ?>
        </div>
    </div>
        ...
        <div class="donors-table-wrapper">
            <table class="donors-table">
                ...
                <tbody id="donorsTableBody">
                    <?php $__empty_1 = true; $__currentLoopData = $fundraiser->donors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $donor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr id="donor-row-<?php echo e($donor->id); ?>">
                        <td><?php echo e($index + 1); ?></td>
                        <td class="donor-name"><?php echo e(strtoupper($donor->name)); ?></td>
                        <td class="donor-email"><?php echo e(strtolower($donor->email)); ?></td>
                        <td class="donor-phone"><?php echo e(strtoupper($donor->phone)); ?></td>
                        <td>RM <?php echo e(number_format($donor->amount, 2)); ?></td>
                        <td><?php echo e(strtoupper($donor->notes ?? '-')); ?></td>

                        <td>
                            <?php if($donor->receipt_path): ?>
                                <a href="<?php echo e(asset('storage/'.$donor->receipt_path)); ?>"
                                   target="_blank"
                        ...
                        <td>
                            <?php if($donor->submitted_form_path): ?>
                                <a href="<?php echo e(asset('storage/'.$donor->submitted_form_path)); ?>"
                                   target="_blank"
                                   class="receipt-link">View</a>
                            <?php else: ?>
                                <span class="no-receipt">-</span>
                        ...
                        <td><?php echo e(\Carbon\Carbon::parse($donor->created_at)->format('d/m/Y H:i')); ?></td>

                        <td>
                            <span class="status-badge status-<?php echo e(strtolower($donor->status)); ?>">
                                <?php echo e(strtoupper($donor->status)); ?>
                        ...
                        <td class="action-buttons">
                            <button class="icon-btn edit-btn"
                                    onclick="openEditDonorModal(<?php echo e($donor->id); ?>)">
                                <img src="/assets/icons/update.png">
                            </button>
                            <button class="icon-btn delete-btn"
                                    onclick="confirmDeleteDonor(<?php echo e($donor->id); ?>, '<?php echo e($donor->name); ?>')">
...
<script>
    window.fundraiserId = "<?php echo e($fundraiser->id); ?>";
</script>

<?php $__env->stopSection(); ?>

<?php echo $__env->make('admin.layouts.admin-template', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp2\htdocs\dashboard\kedahforward\resources\views/admin/fundraisers/programme-detail.blade.php ENDPATH**/ ?>