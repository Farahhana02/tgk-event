...
<div class="pp-wrap">
    ...
    <div class="pp-progress">
        <div class="pp-progress-track">
            ...
            <div class="pp-progress-step">
                <span><?php echo e($hasCommercialFlow ? 4 : 3); ?></span>
    ...
    <form method="POST"
          action="<?php echo e(route('participation.public.submit', $programme->public_token)); ?>"
        ...
        <div class="pp-card">
            ...
            <div class="pp-grid-2">
                <div class="pp-field">
                    ...
                    <input class="pp-input" value="<?php echo e($programme->title); ?>" readonly>
                </div>
                <div class="pp-field">
                    <div class="pp-label">Venue</div>
                    <input class="pp-input" value="<?php echo e($programme->venue ?? '-'); ?>" readonly>
            ...
            <div class="pp-grid-3" style="margin-top: 16px;">
                <div class="pp-field">
                    ...
                    <input class="pp-input" value="<?php echo e(optional($programme->start_date)->format('d/m/Y')); ?>" readonly>
                    <div class="pp-note">Programme commencement date</div>
                </div>
                <div class="pp-field">
                    <div class="pp-label">End Date</div>
                    <input class="pp-input" value="<?php echo e(optional($programme->end_date)->format('d/m/Y')); ?>" readonly>
                ...
                <div class="pp-field">
                    ...
                    ?>
                    <input class="pp-input" value="<?php echo e($timeDisplay); ?>" readonly>
        ...
        <div class="pp-card">
            ...
            <div class="pp-grid-3">
                ...
                <div class="pp-field">
                    ...
                    <input class="pp-input uppercase-field"
                           name="officer_name"
                           value="<?php echo e(old('officer_name')); ?>"
                    ...
                    <select class="pp-select" name="package_id" data-package-select required>
                        ...
                        <?php $__currentLoopData = $packages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pkg): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <option value="<?php echo e($pkg->id); ?>"
                                    ...
                                    data-people="<?php echo e($peopleCount); ?>"
                                    data-type="<?php echo e($pkg->package->package_type); ?>"
                                    <?php echo e(old('package_id') == $pkg->id ? 'selected' : ''); ?>>
                                <?php echo e($packageType); ?> - <?php echo e($pkg->package->name); ?> (RM <?php echo e($price); ?>)
                                <?php if($pkg->package->package_type === 'multi_person'): ?>
                                    - <?php echo e($peopleCount); ?> pax per package
                                <?php endif; ?>
                            </option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
...
$message = $__bag->first($__errorArgs[0]); ?>
                        <div class="pp-error-message" style="color:#dc2626;font-size:12px;margin-top:4px;"><?php echo e($message); ?></div>
                    <?php unset($message);
...
<div class="pp-card">
    <h3 class="pp-card-title" data-section="Section <?php echo e($hasCommercialFlow ? 4 : 3); ?>">
    ...
    <?php else: ?>
        ...
        <div data-participants-wrap id="participants-manual-wrap">
                ...
                <div>
                    ...
                    <div class="pp-field">
                        ...
                        <input class="pp-input uppercase-field" 
                               ...
                               value="<?php echo e(old('participants.0.name')); ?>"
                               required 
                ...
                <div>
                    ...
                    <div class="pp-field">
                        ...
                        <input class="pp-input uppercase-field" 
                               ...
                               value="<?php echo e(old('participants.0.position')); ?>"
                               required 
            ...
            <?php if(old('participants')): ?>
                <?php $__currentLoopData = old('participants'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $participant): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php if($index > 0): ?>
                    <div class="pp-participant-row" data-participant-item="1">
                        <div>
                            <div class="pp-row-title">Participant <?php echo e($index + 1); ?></div>
                            <div class="pp-field">
                                <div class="pp-label required">Name</div>
                                <input class="pp-input uppercase-field" 
                                       type="text" 
                                       name="participants[<?php echo e($index); ?>][name]" 
                                       value="<?php echo e($participant['name'] ?? ''); ?>"
                                       required 
                                       placeholder="ENTER FULL NAME">
                            </div>
                        </div>
                        <div>
                            ...
                            <div class="pp-field">
                                ...
                                <input class="pp-input uppercase-field" 
                                       type="text" 
                                       name="participants[<?php echo e($index); ?>][position]" 
                                       value="<?php echo e($participant['position'] ?? ''); ?>"
                                       required 
                                       placeholder="ENTER POSITION">
                            </div>
                        </div>
...
<div class="pf-card">
    ...
    <div class="pf-field">
        <a href="<?php echo e(asset('storage/'.$programme->upload_form_path)); ?>"
                ...
                <select class="pp-select" name="payment_method_id" data-payment-select required>
                    ...
                    <?php $__currentLoopData = $paymentMethods; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pm): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <option value="<?php echo e($pm->id); ?>"
                                ...
                                data-account="<?php echo e($accountNumber); ?>"
                                data-name="<?php echo e($accountName); ?>"
                                data-type="bank"
                                <?php echo e(old('payment_method_id') == $pm->id ? 'selected' : ''); ?>>
                            <?php echo e($bankName); ?> - <?php echo e($accountName); ?> (<?php echo e($accountNumber); ?>)
                        </option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
            ...
            <?php if($programme->qr_path): ?>
                <div data-qr-info style="display:none;animation:fadeIn 0.3s ease-out;">
                    ...
                    <div class="pp-qr-box" style="background:linear-gradient(135deg,#f0fdf4 0%,#ecfdf5 100%);border:2px solid #bbf7d0;">
                        <img class="pp-qr-img" src="<?php echo e(asset('storage/'.$programme->qr_path)); ?>" alt="Payment QR Code"
            ...
            <div class="pp-field">
                ...
                <div class="pp-file-upload"
                    ...
                    <p style="margin:0;color:#6b7280;font-size:14px;">
                        Max file size: <?php echo e($programme->receipt_max_mb ?? 20); ?> MB
                        <br>
...
<script>
    window.__PACKAGE_MAP__ = <?php echo json_encode($packageData ?? [], 15, 512) ?>;
    window.__PAYMENT_MAP__ = <?php echo json_encode($paymentData ?? [], 15, 512) ?>;
    window.__PROGRAMME__ = <?php echo json_encode($jsProgramme, 15, 512) ?>;
</script>


<script src="<?php echo e(asset('assets/js/public-participation.js')); ?>"></script>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp2\htdocs\dashboard\kedahforward\resources\views/participations/form.blade.php ENDPATH**/ ?>